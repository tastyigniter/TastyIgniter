...
<div class="wrap">
	...
	<table border="0" cellpadding="2" width="100%" id="collection-time" class="form">
		<tr>
			...
			<td>
			<?php if ($order_type === '1') { ?>
				<input type="radio" class="order_type" name="order_type" value="<?php echo $order_type; ?>" checked="checked" /> <?php echo $entry_delivery; ?><br />
			<?php } else { ?>
				<input type="radio" class="order_type" name="order_type" value="1" /> <?php echo $entry_delivery; ?><br />
			<?php } ?>

			<?php if ($order_type === '2') { ?>
				<input type="radio" class="order_type" name="order_type" value="<?php echo $order_type; ?>" checked="checked" /> <?php echo $entry_collection; ?><br />
			<?php } else { ?>
