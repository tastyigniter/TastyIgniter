    ...
    <table width="100%" align="center" class="list">
		<tbody>
			...
			<tr id="<?php echo $menu['menu_id']; ?>">
				...
				<td align="center">
				<div class="cart">
					<img class="add_cart" alt="Add" title="Add to order" src="<?php echo base_url('assets/img/add-menu.png'); ?>" onClick="addToCart('<?php echo $menu['menu_id']; ?>');" />
				</div>
				</td>
			</tr>
			<?php } ?>
