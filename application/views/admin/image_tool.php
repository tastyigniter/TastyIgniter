	...
	<form accept-charset="utf-8" method="post" action="<?php echo current_url(); ?>" >
		<div class="wrap_heading">
			<ul id="tabs">
				...
				<li><a rel="#general">Settings</a></li>
			</ul>
		</div>
		...
		<div id="general" class="wrap_content" style="display:none;">
			<table class="form">
			<tr>
			...
			<tr>
				<td><span class="red">*</span> <b>Maximum File Size(kb):</b><br />
			...
			<tr>
				...
				<td><input type="text" name="thumb_height" value="<?php echo set_value('thumb_height', $thumb_height); ?>" class="textfield" size="5" /> x 
					<input type="text" name="thumb_width" value="<?php echo set_value('thumb_width', $thumb_width); ?>" class="textfield" size="5" /></td>
			</tr>
			<tr>
				<td><span class="red">*</span> <b>Mini Thumbnail Size:</b><br />
				<font size="1">(Height x Width)</font></td>
				<td><input type="text" name="thumb_height_mini" value="<?php echo set_value('thumb_height_mini', $thumb_height_mini); ?>" class="textfield" size="5" /> x 
					<input type="text" name="thumb_width_mini" value="<?php echo set_value('thumb_width_mini', $thumb_width_mini); ?>" class="textfield" size="5" /></td>
			</tr>
			<tr>
