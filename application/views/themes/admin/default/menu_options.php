			...
			<table align="center" class="list list-height">
				<thead>
					<tr>
						...
						<th class="sorter"><a href="<?php echo $sort_name; ?>">Name<i class="icon icon-sort-<?php echo ($sort_by == 'option_name') ? $order_by_active : $order_by; ?>"></i></a></th>
						<th class="sorter"><a href="<?php echo $sort_price; ?>">Price<i class="icon icon-sort-<?php echo ($sort_by == 'option_price') ? $order_by_active : $order_by; ?>"></i></a></th>
						<th class="id"><a href="<?php echo $sort_id; ?>">ID<i class="icon icon-sort-<?php echo ($sort_by == 'option_id') ? $order_by_active : $order_by; ?>"></i></a></th>
					</tr>
				</thead>
				<tbody>
					<?php if ($menu_options) {?>
