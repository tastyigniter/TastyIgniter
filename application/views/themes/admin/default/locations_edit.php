<div id="box-content">
	...
	<form accept-charset="utf-8" method="post" action="<?php echo $action; ?>">
		...
		<div id="working-hours" class="wrap_content" style="display:none;">
			<table class="form">
				...
				<tbody>
					...
					<tr>
						<td><b><?php echo $hour['day']; ?></b></td>
						<td><input type="text" name="hours[open][]" value="<?php echo set_value('hours[open][]', $hour['open']); ?>" class="mini hours" size="4" /></td>
						<td><input type="text" name="hours[close][]" value="<?php echo set_value('hours[close][]', $hour['close']); ?>" class="mini hours" size="4" /></td>
					</tr>
					<?php } ?>
				</tbody>
			</table>
		...
		<div id="reservation" class="wrap_content" style="display:none;">
			<table class="form">
				<tbody>
					<tr>
						<td><b>Tables:</b></td>
						<td><input type="text" name="table" value="" class="textfield" /></td>
					</tr>
					<tr>
						<td></td>
					...
					<tr>
						...
						<td><input type="text" name="reserve_interval" value="<?php echo set_value('reserve_interval', $reserve_interval); ?>" class="textfield" /></td>
					</tr>
					<tr>
						<td><b>Turn Time:</b><br />
						<font size="1">Set in minutes the turn time for each reservation</font></td>
						<td><input type="text" name="reserve_turn" value="<?php echo set_value('reserve_turn', $reserve_turn); ?>" class="textfield" /></td>
					</tr>
				</tbody>
			</table>
		</div>
		...
		<div id="covered-area" class="wrap_content" style="display:none;">
			...
			<?php } else { ?>	
				<p align="center"><font size="3" color="red">You can only set covered area after location has been saved.</font></p>  	
			<?php } ?>	
		</div>
