...
<div class="img_inner">
	...
	<table height="" class="list">
		<tr>
			<th width="1"></th>
			<th align="left" width="25%">Name/Options</th>
	...
	<div class="buttons">
		<div class="left"><a class="button" href="<?php echo $back_url; ?>"><?php echo $button_back; ?></a></div>
		<div class="right"><a class="button" href="<?php echo $reorder_url; ?>"><?php echo $button_reorder; ?></a></div>
	</div>
</div>
</div>