...
class CI_Pagination {
	...
	function create_links()
	{
		...
		if ($this->next_link !== FALSE AND $this->cur_page < $num_pages)
		{
			...
			$output .= $this->next_tag_open.'<a '.$this->anchor_class.'href="'.$this->base_url.$i.$this->suffix.'">'.$this->next_link.'</a>'.$this->next_tag_close;
		}
		...
		if ($this->last_link !== FALSE AND ($this->cur_page + $this->num_links) < $num_pages)
		{
			...
			$output .= $this->last_tag_open.'<a '.$this->anchor_class.'href="'.$this->base_url.$i.$this->suffix.'">'.$this->last_link.'</a>'.$this->last_tag_close;
		}
