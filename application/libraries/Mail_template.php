...
class Mail_template {
	...
	public function setTemplate($template_id, $code) {
		$this->CI->load->model('Mail_templates_model');
		$template = $this->CI->Mail_templates_model->getTemplateData($template_id, $code);
...
/* Location: ./application/libraries/Mail_template.php */