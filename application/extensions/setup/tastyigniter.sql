...
INSERT INTO `ti_currencies` (`currency_id`, `currency_title`, `currency_code`, `currency_symbol`, `currency_status`) VALUES ('7', 'Pounds', 'GBP', '£', '1');
INSERT INTO `ti_currencies` (`currency_id`, `currency_title`, `currency_code`, `currency_symbol`, `currency_status`) VALUES ('8', 'US Dollars', 'USD', '$', '1');
INSERT INTO `ti_currencies` (`currency_id`, `currency_title`, `currency_code`, `currency_symbol`, `currency_status`) VALUES ('9', 'Euro', 'EUR', '€', '1');
INSERT INTO `ti_currencies` (`currency_id`, `currency_title`, `currency_code`, `currency_symbol`, `currency_status`) VALUES ('10', 'Chinese yuan', 'CNY', '¥', '0');
INSERT INTO `ti_currencies` (`currency_id`, `currency_title`, `currency_code`, `currency_symbol`, `currency_status`) VALUES ('11', 'Naira', 'NGN', '₦', '0');
...
INSERT INTO `ti_settings` (`setting_id`, `sort`, `key`, `value`, `serialized`) VALUES ('5094', 'config', 'reserve_prefix', '0', '0');
