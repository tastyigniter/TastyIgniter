					...
					<table class="table table-striped table-border table-sortable">
						...
						<tbody> 
							...
							<tr id="module-row<?php echo $table_row; ?>">
								...
								<td><select name="layouts[<?php echo $table_row; ?>][banner_id]" class="form-control">
									...
									<?php echo form_error('layouts['.$table_row.'][banner_id]', '<span class="text-danger small">', '</span>'); ?>
								</td>
...
function addModule() {	
    ...
    html += '	<td><select name="layouts[' + table_row + '][banner_id]" class="form-control">';
		<?php foreach ($banners as $banner) { ?>
