...
class Banners extends MX_Controller {
	...
	public function __construct() {
		...
		$this->lang->load('banners/banners', $this->language->folder());
	}

	public function index($setting) {
		if ( ! file_exists(EXTPATH .'modules/banners/views/main/banners.php')) { 				//check if file exists in views folder
		...
		$this->load->view('banners/main/banners', $data);
	}		
}

/* End of file banners.php */
/* Location: ./application/extensions/modules/banners/controllers/main/banners.php */