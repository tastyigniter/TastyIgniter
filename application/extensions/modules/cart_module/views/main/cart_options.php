<div class="modal-dialog">
	<div class="modal-content">
		...
		<div class="modal-body">
			...
			<div id="menu-options<?php echo $menu_id; ?>" class="menu-options">
									...
									<?php foreach ($menu_option['option_values'] as $option_value) { ?>
										<?php if (in_array($option_value['menu_option_value_id'], $menu_option_value_ids)) { ?>
											<div class="radio"><label>	
												...
												<?php echo $option_value['value']; ?> <span class="price pull-right"><?php echo $option_value['price']; ?></span>
											</label></div>
										<?php } else { ?>
											<div class="radio"><label>	
					...
					<div class="col-sm-5 wrap-none">
						...
						<div class="input-group quantity-control">
							<span class="input-group-btn">
							    <button class="btn btn-default" type="button">&minus;</button>
							</span>
				...
				<div class="clearfix"></div>
				<?php if ($row_id) { ?>
					<a class="btn btn-success btn-cart-lg pull-right" onclick="addToCart('<?php echo $menu_id; ?>');" title="Update">UPDATE</a>
				<?php } else { ?>	
					<a class="btn btn-success btn-cart-lg pull-right" onclick="addToCart('<?php echo $menu_id; ?>');" title="Add to order">ADD TO ORDER</a>
				<?php } ?>	
				<div class="clearfix"></div>
...
$(document).ready(function() {
	...
	$('.quantity-control .btn').on('click', function() {
		...
		$button.parent().parent().find('#quantity').attr('value', newVal);
	});
});
//--></script>