<div id="reservation-box" class="module-box">
	<div class="panel panel-default">
		...
		<div class="panel-body reservation-alert" style="display:<?php echo ($reservation_alert) ? 'block' : 'none'; ?>">
		...
		<form method="GET" accept-charset="utf-8" action="<?php echo current_url(); ?>" id="find-table-form" role="form">
			<div class="find-table-box wrap-vertical" style="display:<?php echo (!$show_times) ? 'block' : 'none'; ?>">
				<div class="form-group">
					...
					<?php echo form_error('location', '<span class="error help-block">', '</span>'); ?>
				</div>
				<div class="form-group">
					...
					<?php } ?>
					<?php echo form_error('guest_num', '<span class="error help-block">', '</span>'); ?>
				</div>
				<div class="form-group">
					...
					<?php echo form_error('reserve_date', '<span class="error help-block">', '</span>'); ?>
				</div>
				<div class="form-group">
			...
			<div class="time-table-box wrap-vertical" style="display:<?php echo ($show_times) ? 'block' : 'none'; ?>">
				...
				<div class="buttons wrap-horizontal">
					...
					<button type="submit" class="btn btn-success" style="display:<?php echo ($reserve_times) ? 'inline-block' : 'none'; ?>"><?php echo $button_time; ?></button>
				</div>
			</div>
		</form>
		</div>
		...
		<?php if ($show_reserve) { ?>
			<div class="reserve-table-box wrap-all">
				...
				<div class="buttons wrap-horizontal">
					...
					<a class="btn btn-success" onclick="$('#find-table-form, #reserve-form').submit();"><?php echo $button_reservation; ?></a>
				</div>
			</div>
		<?php } ?>
	</div>
