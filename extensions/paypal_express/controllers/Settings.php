...
class Settings extends Admin_Controller {
	...
	public function index($module = array()) {
		...
		if ($this->input->post() AND $this->_updatePayPalExpress() === TRUE) {
			...
			$this->redirect(admin_extension_url('paypal_express/settings'));
		}

		return $this->load->view('paypal_express/settings', $data, TRUE);
	}
	...
	protected function _updatePayPalExpress() {
		...
		if ($this->input->post() AND $this->validateForm() === TRUE) {
			...
			if ($this->Extensions_model->updateSettings('paypal_express', $this->input->post())) {
...
/* Location: ./extensions/paypal_express/controllers/Settings.php */