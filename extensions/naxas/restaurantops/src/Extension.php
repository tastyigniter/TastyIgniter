        ...
        return [
            'restaurant-operations' => [
                ...
                'child' => [
                    ...
                    'restaurant-ops-head-office' => ['priority' => 20, 'class' => 'restaurant-ops-head-office', 'title' => lang('Naxas.RestaurantOps::default.navigation.head_office'), 'href' => route('naxas.restaurantops.head-office'), 'permission' => 'Restaurant.Operations.HeadOfficeDashboard'],
                    'restaurant-ops-branch' => ['priority' => 30, 'class' => 'restaurant-ops-branch', 'title' => lang('Naxas.RestaurantOps::default.navigation.branch'), 'href' => route('naxas.restaurantops.branch-operations'), 'permission' => 'Restaurant.Operations.BranchDashboard'],
                    'restaurant-ops-cashier' => ['priority' => 40, 'class' => 'restaurant-ops-cashier', 'title' => lang('Naxas.RestaurantOps::default.navigation.cashier'), 'href' => route('naxas.restaurantops.cashier'), 'permission' => 'Restaurant.POS.Access'],
                    ...
                    'restaurant-ops-menu-config' => ['priority' => 70, 'class' => 'restaurant-ops-menu-config', 'title' => lang('Naxas.RestaurantOps::default.navigation.menu_configuration'), 'href' => route('naxas.restaurantops.menu-config.index'), 'permission' => 'Restaurant.MenuConfig.View'],
