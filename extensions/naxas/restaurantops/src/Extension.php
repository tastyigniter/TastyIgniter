        ...
        return [
            'restaurant-operations' => [
                ...
                'child' => [
                    ...
                    'restaurant-ops-menu-config' => ['title' => 'naxas.restaurantops::default.navigation.menu_configuration', 'href' => admin_url('restaurant-ops/menu-configuration'), 'permission' => 'Restaurant.MenuConfig.Access'],
                ],
            ],
        ];
    }
