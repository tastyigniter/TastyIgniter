...
class Settings extends Admin_Controller {
	...
	public function index($module = array()) {
        ...
        if (!empty($module)) {
			...
			if ($this->input->post() AND $this->_updateModule() === TRUE) {
				...
				$this->redirect(admin_extension_url('cart_module/settings'));
			}
            ...
            return $this->load->view('cart_module/settings', $data, TRUE);
        }
	}
	...
	protected function _updateModule() {
    	...
    	if ($this->validateForm() === TRUE) {
			...
			if ($this->Extensions_model->updateSettings('cart_module', $this->input->post())) {
...
/* Location: ./extensions/cart_module/controllers/Settings.php */