					...
					<div class="btn-group btn-group-md order-type" data-toggle="buttons">
						<?php if ($order_type === '1') { ?>
							<label class="btn btn-default btn-primary active" data-btn="btn-primary">
								<input type="radio" name="order_type" value="1" checked="checked">&nbsp;&nbsp;<?php echo lang('text_delivery'); ?>
							    <span class="small center-block"><?php echo $delivery_time.' '.lang('text_min'); ?></span>
                            </label>
							<label class="btn btn-default" data-btn="btn-primary">
								<input type="radio" name="order_type" value="2">&nbsp;&nbsp;<?php echo lang('text_collection'); ?>
                                <span class="small center-block"><?php echo $collection_time.' '.lang('text_min'); ?></span>
                            </label>
						<?php } else if ($order_type === '2') { ?>
							<label class="btn btn-default" data-btn="btn-primary">
								<input type="radio" name="order_type" value="1">&nbsp;&nbsp;<?php echo lang('text_delivery'); ?>
                                <span class="small center-block"><?php echo $delivery_time.' '.lang('text_min'); ?></span>
                            </label>
							<label class="btn btn-default btn-primary active" data-btn="btn-primary">
								<input type="radio" name="order_type" value="2" checked="checked">&nbsp;&nbsp;<?php echo lang('text_collection'); ?>
                                <span class="small center-block"><?php echo $collection_time.' '.lang('text_min'); ?></span>
                            </label>
						<?php } else { ?>
							<label class="btn btn-default" data-btn="btn-primary">
