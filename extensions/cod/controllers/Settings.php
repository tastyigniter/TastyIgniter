...
class Settings extends Admin_Controller {
	...
	public function index($module = array()) {
        ...
        if (!empty($module)) {
            ...
            if ($this->input->post() AND $this->_updateCod() === TRUE){
                ...
                $this->redirect(admin_extension_url('cod/settings'));
            }

            return $this->load->view('cod/settings', $data, TRUE);
        }
	}
	...
	protected function _updateCod() {
    	...
    	if ($this->validateForm() === TRUE) {
			...
			if ($this->Extensions_model->updateSettings('cod', $this->input->post())) {
...
/* Location: ./extensions/cod/controllers/Settings.php */