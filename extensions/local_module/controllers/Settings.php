...
class Settings extends Admin_Controller {
	...
	public function index($module = array()) {
        ...
        if (!empty($module)) {
	        ...
	        if ($this->input->post() AND $this->_updateModule() === TRUE) {
                ...
                $this->redirect(admin_extension_url('local_module/settings'));
            }

            return $this->load->view('local_module/settings', $data, TRUE);
        }
	}
	...
	protected function _updateModule() {
    	...
    	if ($this->validateForm() === TRUE) {
			...
			if ($this->Extensions_model->updateSettings('local_module', $this->input->post())) {
...
/* Location: ./extensions/local_module/controllers/Settings.php */