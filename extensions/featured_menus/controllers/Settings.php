...
class Settings extends Admin_Controller {
	...
	public function index($module = array()) {
        ...
        if ($this->input->post() AND $this->_updateModule() === TRUE) {
            ...
            $this->redirect(admin_extension_url('featured_menus/settings'));
        }
        ...
        return $this->load->view('featured_menus/settings', $data, TRUE);
    }
    ...
    protected function _updateModule() {
        ...
        if ($this->validateForm() === TRUE) {
            ...
            if ($this->Extensions_model->updateSettings('featured_menus', $this->input->post())) {
...
/* Location: ./extensions/featured_menus/controllers/Settings.php */