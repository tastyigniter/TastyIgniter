...
test('validation results as expected', function ($callback) {
    ...
    'request_should_fail_when_no_enable_request_log_is_provided' => [
        function () {
            return [FALSE, array_except(validationData(), 'enable_request_log')];
        },
    ],
    'request_should_fail_when_no_maintenance_mode_is_provided' => [
        function () {
            return [FALSE, array_except(validationData(), 'maintenance_mode')];
        },
    ],
    'request_should_fail_when_no_maintenance_message_is_provided' => [
        function () {
            return [FALSE, array_merge(validationData(), [
    ...
    'request_should_fail_when_no_activity_log_timeout_is_provided' => [
        function () {
            return [FALSE, array_except(validationData(), 'activity_log_timeout')];
        },
    ],
    'request_should_fail_when_enable_request_log_is_not_boolean' => [
        function () {
            return [FALSE, array_merge(validationData(), ['maintenance_mode' => faker()->word()])];
        },
    ],
    ...
    'request_should_fail_when_maintenance_message_is_not_string' => [
        function () {
            return [FALSE, array_merge(validationData(), ['maintenance_message' => []]),];
        },
    ],
    'request_should_fail_when_activity_log_timeout_is_greater_than_999' => [
        function () {
            return [FALSE, array_merge(validationData(), ['activity_log_timeout' => faker()->numberBetween(1000, 99999)])];
        },
    ],
