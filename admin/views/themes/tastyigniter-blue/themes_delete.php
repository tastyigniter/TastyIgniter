        ...
        <form role="form" id="edit-form" class="form-horizontal" accept-charset="utf-8" method="POST" action="<?php echo current_url(); ?>">
            <div class="panel panel-default">
                <div class="panel-body">
                    <?php $delete_action = !empty($theme_data) ? $this->lang->line('text_files_data') : $this->lang->line('text_files'); ?>
                    <p><?php echo sprintf(lang('alert_delete_warning'), $delete_action, $theme_name); ?></p>
                    <div id="deletedFiles">
                        <textarea class="form-control" rows="10" readonly><?php echo implode(PHP_EOL, $files_to_delete); ?></textarea>
                    </div>
                    <p class="wrap-top"><?php echo sprintf(lang('alert_delete_confirm'), $delete_action); ?></p>
                    <?php if ($theme_data) { ?>
                ...
                <div class="panel-footer">
                    <input type="hidden" name="confirm_delete" value="<?php echo $theme_code; ?>">
