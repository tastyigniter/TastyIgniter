						...
						<div class="col-sm-5">
							<div class="btn-group btn-group-toggle" data-toggle="buttons">
								<?php if ($table_status == '1') { ?>
									<label class="btn btn-default" data-btn="btn-danger"><input type="radio" name="table_status" value="0" <?php echo set_radio('table_status', '0'); ?>>Disabled</label>
									<label class="btn btn-default active" data-btn="btn-success"><input type="radio" name="table_status" value="1" <?php echo set_radio('table_status', '1', TRUE); ?>>Enabled</label>
								<?php } else { ?>
									<label class="btn btn-default active" data-btn="btn-danger"><input type="radio" name="table_status" value="0" <?php echo set_radio('table_status', '0', TRUE); ?>>Disabled</label>
									<label class="btn btn-default" data-btn="btn-success"><input type="radio" name="table_status" value="1" <?php echo set_radio('table_status', '1'); ?>>Enabled</label>
								<?php } ?>
							</div>
