				...
				<table border="0" class="table table-striped table-border">
					...
					<tbody>
						...
						<tr>
							<td class="action">
								<div class="checkbox checkbox-primary">
									<input type="checkbox" class="styled" id="checkbox-<?php echo $language['language_id']; ?>" value="<?php echo $language['language_id']; ?>" name="delete[]" />
									<label for="checkbox-<?php echo $language['language_id']; ?>"></label>
								</div>
