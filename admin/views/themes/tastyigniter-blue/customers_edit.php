					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<div id="input-newsletter" class="btn-group btn-group-toggle" data-toggle="buttons">
								<?php if ($newsletter == '1') { ?>
									<label class="btn btn-default" data-btn="btn-danger"><input type="radio" name="newsletter" value="0" <?php echo set_radio('newsletter', '0'); ?>><?php echo lang('text_un_subscribe'); ?></label>
									<label class="btn btn-default active" data-btn="btn-success"><input type="radio" name="newsletter" value="1" <?php echo set_radio('newsletter', '1', TRUE); ?>><?php echo lang('text_subscribe'); ?></label>
								<?php } else { ?>
									<label class="btn btn-default active" data-btn="btn-danger"><input type="radio" name="newsletter" value="0" <?php echo set_radio('newsletter', '0', TRUE); ?>><?php echo lang('text_un_subscribe'); ?></label>
									<label class="btn btn-default" data-btn="btn-success"><input type="radio" name="newsletter" value="1" <?php echo set_radio('newsletter', '1'); ?>><?php echo lang('text_subscribe'); ?></label>
								<?php } ?>
							</div>
				...
				<div id="addresses" class="tab-pane row wrap-all">
					...
					<?php if ($addresses) { ?>
						...
						<div id="address<?php echo $table_row; ?>" class="tab-pane row wrap-all">
							...
							<div class="form-group">
								<label for="input-name" class="col-sm-3 control-label"><?php echo lang('label_address_1'); ?></label>
								<div class="col-sm-5">
							...
							<div class="form-group">
								<label for="input-name" class="col-sm-3 control-label"><?php echo lang('label_postcode'); ?></label>
								<div class="col-sm-5">
							...
							<div class="form-group">
								<label for="input-name" class="col-sm-3 control-label"><?php echo lang('label_country'); ?></label>
								<div class="col-sm-5">
...
function addAddress() {
	...
	html += '	<label for="input-name" class="col-sm-3 control-label"><?php echo lang('label_address_1'); ?></label>';
	...
	html += '</div>';
	html += '<div class="form-group">';
	html += '	<label for="input-name" class="col-sm-3 control-label"><?php echo lang('label_address_2'); ?></label>';
	html += '	<div class="col-sm-5">';
	...
	html += '</div>';
	html += '<div class="form-group">';
	html += '	<label for="input-name" class="col-sm-3 control-label"><?php echo lang('label_city'); ?></label>';
	html += '	<div class="col-sm-5">';
	html += '		<input type="text" name="address[' + table_row + '][city]" id="" class="form-control" value="<?php echo set_value("address[' + table_row + '][city]"); ?>" />';
	html += '	</div>';
	html += '</div>';
	html += '<div class="form-group">';
	html += '	<label for="input-name" class="col-sm-3 control-label"><?php echo lang('label_postcode'); ?></label>';
	html += '	<div class="col-sm-5">';
	...
	html += '</div>';
	html += '<div class="form-group">';
	html += '	<label for="input-name" class="col-sm-3 control-label"><?php echo lang('label_country'); ?></label>';
	html += '	<div class="col-sm-5">';
