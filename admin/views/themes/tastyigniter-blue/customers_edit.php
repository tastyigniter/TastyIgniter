					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<div id="input-newsletter" class="btn-group btn-group-toggle" data-toggle="buttons">
								<?php if ($newsletter == '1') { ?>
									<label class="btn btn-default" data-btn="btn-danger"><input type="radio" name="newsletter" value="0" <?php echo set_radio('newsletter', '0'); ?>>Unsubscribe</label>
									<label class="btn btn-default active" data-btn="btn-success"><input type="radio" name="newsletter" value="1" <?php echo set_radio('newsletter', '1', TRUE); ?>>Subscribe</label>
								<?php } else { ?>
									<label class="btn btn-default active" data-btn="btn-danger"><input type="radio" name="newsletter" value="0" <?php echo set_radio('newsletter', '0', TRUE); ?>>Unsubscribe</label>
									<label class="btn btn-default" data-btn="btn-success"><input type="radio" name="newsletter" value="1" <?php echo set_radio('newsletter', '1'); ?>>Subscribe</label>
								<?php } ?>
							</div>
