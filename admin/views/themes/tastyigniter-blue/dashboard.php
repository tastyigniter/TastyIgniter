...
<!--[if IE]>
<script type="text/javascript" src="<?php echo root_url("assets/js/jquery.flot.excanvas.js"); ?>"></script>
<![endif]-->
<script type="text/javascript" src="<?php echo root_url("assets/js/jquery.flot.js"); ?>"></script>
...
function getChart(range) {
	...
	if (monthly) {
		var url = '<?php echo site_url("dashboard/chart?range="); ?>' + monthly + '&type=' + type;
	} else {
		var url = '<?php echo site_url("dashboard/chart?range="); ?>' + range + '&type=' + type;
	}
