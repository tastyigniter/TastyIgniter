...
class Location extends FormRequest
{
    public function rules()
    {
        return [
            ...
            ['location_postcode', 'admin::lang.locations.label_postcode', 'max:15'],
            ...
            ['location_lat', 'admin::lang.locations.label_latitude', 'required_if:options.auto_lat_lng,0|numeric'],
            ['location_lng', 'admin::lang.locations.label_longitude', 'required_if:options.auto_lat_lng,0|numeric'],
