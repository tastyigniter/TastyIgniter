...
class Location extends FormRequest
{
    public function rules()
    {
        return [
            ...
            ['options.delivery_time_restriction', 'admin::lang.locations.label_delivery_time_restriction', 'integer|max:2'],
            ['options.collection_time_restriction', 'admin::lang.locations.label_collection_time_restriction', 'integer|max:2'],
