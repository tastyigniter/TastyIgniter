...
class UserGroup extends FormRequest
{
    public function attributes()
    {
        return [
            ...
            'assignment_availability' => lang('admin::lang.user_groups.label_assignment_availability'),
            'load_balanced_limit' => lang('admin::lang.user_groups.label_load_balanced_limit'),
        ];
    }
