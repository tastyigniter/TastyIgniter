...
return [
    ...
    'permissions' => [
        ...
        'impersonate_staff' => 'Ability to impersonate user',
    ...
    'user_groups' => [
        ...
        'help_load_balanced_limit' => 'Maximum number of orders per user.',
    ...
    'staff' => [
        ...
        'help_send_invite' => 'Sends an invitation message containing a link to set a password on their account.',
        'help_super_staff' => 'Grants this user unlimited access to all areas of the system. Super user can add and manage other user.',
        ...
        'alert_impersonate_confirm' => 'Are you sure you want to impersonate this user? You can revert to your original state by logging out.',
        'alert_impersonate_success' => 'You are now impersonating user: %s',
    ],
