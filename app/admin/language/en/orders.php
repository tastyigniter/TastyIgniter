...
return [
    'text_title'                 => 'Orders',
    'text_new_title'             => 'Order: New',
    'text_edit_title'            => 'Order: Update',
    'text_preview_title'         => 'Order: Preview',
    'text_form_name'             => 'Order',
    'text_invoice_heading'       => 'Order Invoice: %s',
    'text_tab_general'           => 'Order',
    'text_tab_status'            => 'Status History',
    ...
    'text_menu_options'          => '<span class="small">%s</span>: %s %s <span class="small">%s</span>',
