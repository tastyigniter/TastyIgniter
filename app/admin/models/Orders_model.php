...
class Orders_model extends Model
{
    ...
    public function mailGetData()
    {
        ...
        $data['order_time'] = Carbon::createFromTimeString($model->order_time)->format(lang('admin::lang.time_format'));
        $data['order_date'] = $model->order_date->format(lang('admin::lang.date_format'));
        $data['order_added'] = $model->date_added->format(lang('admin::lang.date_time_format'));

        $data['invoice_id'] = $model->invoice_number;
        $data['invoice_number'] = $model->invoice_number;
        $data['invoice_date'] = $model->invoice_date ? $model->invoice_date->format(lang('admin::lang.date_format')) : null;
