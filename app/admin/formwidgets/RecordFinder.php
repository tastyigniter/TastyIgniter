 ...
 * @package Admin
 */
class RecordFinder extends BaseFormWidget
{
    //
    ...
    /**
     * @var \Admin\Classes\BaseWidget Reference to the widget used for viewing (list or form).
     */
    protected $listWidget;

    /**
     * @var \Admin\Classes\BaseWidget Reference to the widget used for searching.
     */
    ...
    public function render()
    {
        ...
        return $this->makePartial('recordfinder/container');
    }
    ...
    public function prepareVars()
    {
        ...
        $this->vars['prompt'] = str_replace('%s', '<i class="icon-th-list"></i>', e(lang($this->prompt)));
    }

    public function loadAssets()
    {
        $this->addJs('js/recordfinder.js', 'recordfinder-js');
    }
    ...
    {
        list($model, $attribute) = $this->formField->resolveModelAttribute($this->model, $this->valueFrom);
    ...
    protected function makeSearchWidget()
    {
        ...
        $widget = $this->makeWidget('Admin\Widgets\Search', $config);
