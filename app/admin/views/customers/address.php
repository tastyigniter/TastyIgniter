...
<div
    ...
    <div class="form-group span-right <?= form_error($fieldName.'['.$index.'][address_2]') != '' ? 'has-error' : ''; ?>">
        <label class="control-label"><?= lang('admin::customers.label_address_2'); ?></label>
        <input type="text"
    ...
    <div class="form-group span-left <?= form_error($fieldName.'['.$index.'][city]') != '' ? 'has-error' : ''; ?>">
        <label class="control-label"><?= lang('admin::customers.label_city'); ?></label>
        <input type="text"
    ...
    <div class="form-group span-right <?= form_error($fieldName.'['.$index.'][state]') != '' ? 'has-error' : ''; ?>">
        <label class="control-label"><?= lang('admin::customers.label_state'); ?></label>
        <input type="text"
    ...
    <div class="form-group span-left <?= form_error($fieldName.'['.$index.'][postcode]') != '' ? 'has-error' : ''; ?>">
        <label class="control-label"><?= lang('admin::customers.label_postcode'); ?></label>
        <input type="text"
    ...
    <div class="form-group span-right <?= form_error($fieldName.'['.$index.'][country_id]') != '' ? 'has-error' : ''; ?>">
        <label class="control-label"><?= lang('admin::customers.label_country'); ?></label>
