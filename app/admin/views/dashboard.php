    ...
    <div class="col-md-12">
                    ...
                    <div id="statistics">
                        <ul class="list-group">
                            ...
                            <li class="list-group-item"><?= lang('admin::dashboard.text_total_cash_payment'); ?>
                                <span class="text-yellow cash_payments"><?= lang('admin::dashboard.text_zero'); ?></span></li>
                            ...
                            <li class="list-group-item"><?= lang('admin::dashboard.text_total_delivery_order'); ?>
                                <span class="text-success delivery_orders"><?= lang('admin::dashboard.text_zero'); ?></span></li>
                            <li class="list-group-item"><?= lang('admin::dashboard.text_total_collection_order'); ?>
                                <span class="text-info collection_orders"><?= lang('admin::dashboard.text_zero'); ?></span></li>
                            <li class="list-group-item"><?= lang('admin::dashboard.text_total_completed_order'); ?>
                                <span class="text-danger orders_completed"><?= lang('admin::dashboard.text_zero'); ?></span></li>
                            <li class="list-group-item"><?= lang('admin::dashboard.text_total_reserved_table'); ?>
                                <span class="text-primary tables_reserved"><?= lang('admin::dashboard.text_zero'); ?></span></li>
                        </ul>
                    </div>
        ...
        <div>
            <div class="row">
                <div class="col-sm-12 col-md-6">
                    <div class="panel panel-default">
                        <div class="panel-heading"><h3 class="panel-title"><?= lang('admin::dashboard.text_complete_setup'); ?></h3>
                        </div>
                        <div class="panel-body">
                    ...
                    <div class="panel panel-default panel-activities">
                        <div class="panel-heading"><h3 class="panel-title">
                                <i class="fa fa-clock-o"></i>&nbsp;&nbsp;<?= lang('admin::dashboard.text_recent_activity'); ?></h3>
                        </div>
                        <ul class="list-group">
                            <?php if ($activities) { ?>
                ...
                <div class="col-sm-12 col-md-6">
                    <?php if ($news_feed) { ?>
                        <div class="panel panel-default panel-news-feed">
                            <div class="panel-heading"><h3 class="panel-title">
                                    <i class="fa fa-rss"></i>&nbsp;&nbsp;<?= lang('admin::dashboard.text_news'); ?></h3></div>
        ...
        <?php if ($orders) { ?>
            <div class="panel panel-default panel-orders">
                <div class="panel-heading"><h3 class="panel-title">
                        <i class="fa fa-list-alt"></i>&nbsp;&nbsp;<?= lang('admin::dashboard.text_latest_order'); ?></h3></div>
                <div class="table-responsive">
                    <table border="0" class="table table-striped table-no-spacing">
                        <thead>
                        <tr>
                ...
                <div class="panel-footer text-right">
                    <a href="<?= admin_url('orders'); ?>"><?= lang('admin::default.text_see_all_orders'); ?>&nbsp;<i class="fa fa-arrow-right"></i></a>
                </div>
            </div>
        <?php } ?>
    </div>
