...
$this->assets->setMeta(['name' => 'X-UA-Compatible', 'content' => 'IE=edge', 'type' => 'equiv']);
$this->assets->setMeta(['name' => 'viewport', 'content' => 'width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no', 'type' => 'name']);
$this->assets->setFavIcon(root_url('favicon.ico'));
$this->assets->setStyleTag(assets_url('css/vendor/bootstrap.min.css'), 'bootstrap-css', '10');
$this->assets->setStyleTag(assets_url('css/vendor/font-awesome.min.css'), 'font-awesome-css', '11');
$this->assets->setStyleTag('css/metisMenu.min.css', 'metis-menu-css', '12');
$this->assets->setStyleTag(assets_url('css/vendor/select2.css'), 'select2-css', '13');
$this->assets->setStyleTag(assets_url('css/vendor/select2-bootstrap.css'), 'select2-bootstrap-css', '14');
$this->assets->setStyleTag(assets_url('css/vendor/jquery.raty.css'), 'jquery-raty-css', '15');
$this->assets->setStyleTag(assets_url('css/vendor/awesome-checkbox.css'), 'awesome-checkbox-css', '16');
...
$this->assets->setScriptTag(assets_url('js/vendor/select2.js'), 'select-2-js', '12');
$this->assets->setScriptTag(assets_url('js/vendor/jquery.raty.js'), 'jquery-raty-js', '13');
$this->assets->setScriptTag(assets_url('js/vendor/js.cookie.js'), 'js-cookie-js', '14');
            ...
            <ul class="nav navbar-top-links navbar-right">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-locations">
                            <li class="menu-header">
                                <strong><?php echo sprintf(lang('text_locations'), count($locations)); ?></strong></li>
                            <li class="menu-body">
                                <?php if ($locations) { ?>
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-settings">
                        ...
                        <li><a href="<?php echo site_url('error_logs'); ?>"><?php echo lang('menu_error_log'); ?></a>
                        </li>
                        ...
                        <li>
                            <div class="row wrap-vertical text-center">
                                <div class="col-xs-12 wrap-top">
                                    ...
                                    <p class="small">
                                        <i class="fa fa-map-marker"></i>&nbsp;&nbsp;<?php echo $staff_location; ?></p>
                                </div>
                            </div>
                        </li>
                        <li class="divider"></li>
                        <li>
                            <a href="<?php echo $staff_edit; ?>"><i class="fa fa-user fa-fw"></i>&nbsp;&nbsp;<?php echo lang('text_edit_details'); ?>
                            </a></li>
                        <li>
                            <a class="list-group-item-danger" href="<?php echo $logout; ?>"><i class="fa fa-power-off fa-fw"></i>&nbsp;&nbsp;<?php echo lang('text_logout'); ?>
                            </a></li>
                        <li class="divider"></li>
                        <li>
                            <a href="http://tastyigniter.com/about/" target="_blank"><i class="fa fa-info-circle fa-fw"></i>&nbsp;&nbsp;<?php echo lang('text_about_tastyigniter'); ?>
                            </a></li>
                        <li>
                            <a href="http://docs.tastyigniter.com" target="_blank"><i class="fa fa-book fa-fw"></i>&nbsp;&nbsp;<?php echo lang('text_documentation'); ?>
                            </a></li>
                        <li>
                            <a href="http://forum.tastyigniter.com" target="_blank"><i class="fa fa-users fa-fw"></i>&nbsp;&nbsp;<?php echo lang('text_community_support'); ?>
                            </a></li>
                        <li class="divider"></li>
                        <li class="menu-footer"></li>
                    </ul>
