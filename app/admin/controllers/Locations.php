...
class Locations extends \Admin\Classes\AdminController
{
    ...
    public function formValidate($model, $form)
    {
        $rules = [
            ...
            ['options.future_orders', 'lang:admin::locations.label_future_order', 'required|integer'],
            ...
            ['reservation_time_interval', 'lang:admin::locations.label_reservation_time_interval', 'integer'],
            ['reservation_stay_time', 'lang:admin::locations.label_reservation_stay_time', 'integer'],
