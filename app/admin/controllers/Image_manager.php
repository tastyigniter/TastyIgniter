...
class Image_manager extends Admin_Controller
{
    ...
    protected $_uploads = FALSE;
    protected $_new_folder = FALSE;
    ...
    protected function setTemplateTags($popup)
    {
        if ($popup == 'iframe') {
            ...
            $this->assets->setScriptTag(assets_url('js/vendor/js.cookie.js'), 'js-cookie-js', '100');
            $this->assets->setScriptTag('js/vendor/metisMenu.min.js', 'metis-menu-js', '101');
            $this->assets->setScriptTag(assets_url('js/imagemanager/bootbox.min.js'), 'bootbox-js', '102');
            $this->assets->setScriptTag(assets_url('js/vendor/select2.js'), 'select-2-js', '103');
            $this->assets->setScriptTag(assets_url('js/vendor/dropzone.min.js'), 'dropzone-js', '104');
