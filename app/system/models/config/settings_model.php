...
$config['form']['general'] = [
    ...
    'form'     => [
        ...
        'rules' => [
            ...
            ['menu_images_h', 'lang:system::settings.label_menu_image_height', 'required_if:show_menu_images,1|numeric'],
            ['menu_images_w', 'lang:system::settings.label_menu_image_width', 'required_if:show_menu_images,1|numeric'],
