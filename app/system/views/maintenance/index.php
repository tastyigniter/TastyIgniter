    <div class="row-fluid">
        ...
        <div class="tab-heading">
            <ul id="nav-tabs" class="nav nav-tabs">
                <li class="active">
                    <a href="#existing-backup" data-toggle="tab"><?= lang('system::maintenance.text_tab_existing_backup'); ?></a></li>
                <li><a href="#create-backup" data-toggle="tab"><?= lang('system::maintenance.text_tab_create_backup'); ?></a></li>
            </ul>
        </div>
