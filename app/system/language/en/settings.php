...
return [
    ...
    'help_location_order' => 'Set whether customer MUST enter their postcode/address before they can place an order. If disabled, the customer will be allowed to order without entering their postcode/adddress.',
