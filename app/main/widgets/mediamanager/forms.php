<script type="text/template" data-media-new-folder-form>
    <form method="POST" accept-charset="UTF-8">
        <div class="form-group">
            <label><?= e(lang('main::media_manager.text_folder_name')) ?></label>
...
<script type="text/template" data-media-rename-file-form>
    <form method="POST" accept-charset="UTF-8">
        <div class="form-group">
            <label><?= e(lang('main::media_manager.text_file_name')) ?></label>
            <input type="text" class="form-control" name="name"/>
        </div>
    </form>
</script>
...
<script type="text/template" data-media-move-folder-form>
    <form method="POST" accept-charset="UTF-8">
        <div class="form-group">
            <label><?= e(lang('main::media_manager.text_destination_folder')) ?></label>
...
<script type="text/template" data-media-delete-folder-form>
    <form method="POST" accept-charset="UTF-8">
        <p><b><?= e(lang('admin::default.alert_warning_confirm')) ?></b></p>
    </form>
</script>
