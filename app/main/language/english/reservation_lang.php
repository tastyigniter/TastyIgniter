...
$lang = [
    ...
    'alert_no_table'             => '<p class="alert-danger">Please check table availability using the Find A Table form.</p>',
    'alert_reservation_disabled' => '<p class="alert-danger">Table reservation has been disabled, please contact site administrator.</p>',
