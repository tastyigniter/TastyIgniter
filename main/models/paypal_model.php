...
class Paypal_model extends CI_Model {
	...
	public function sendPaypal($method, $nvp_data) {
		$payment = $this->Extensions_model->getPayPalPayment();
		$api_user = (isset($payment['api_user'])) ? $payment['api_user'] : '';
		$api_pass = (isset($payment['api_pass'])) ? $payment['api_pass'] : '';
		$api_signature = (isset($payment['api_signature'])) ? $payment['api_signature'] : '';
		$api_action = (isset($payment['api_action'])) ? $payment['api_action'] : '';
		$return_uri = (isset($payment['return_uri'])) ? $payment['return_uri'] : '';
		$cancel_uri = (isset($payment['cancel_uri'])) ? $payment['cancel_uri'] : '';

		if (isset($payment['api_mode']) AND $payment['api_mode'] === 'sandbox') {
			$api_mode = '.sandbox';
		} else {
			$api_mode = '';
		}
...
/* Location: ./main/extensions/payments/paypal_model/models/paypal_model.php */