...
class Inbox extends Main_Controller {
	...
	public function index() {
		...
		$this->template->setBreadcrumb($this->lang->line('text_heading'), 'inbox');
		...
		$prefs['base_url'] 			= site_url('inbox').$url;
		...
		$this->template->render('inbox', $data);
	}
	...
	public function view() {
		...
		$result = $this->Messages_model->viewMessage($this->customer->getId(), $message_id);								// retrieve specific customer message based on message id to be passed to view

		$this->template->setBreadcrumb('<i class="fa fa-home"></i>', '/');
		$this->template->setBreadcrumb($this->lang->line('text_heading'), 'inbox');
		$this->template->setBreadcrumb($this->lang->line('text_view_heading'), 'inbox/view');
		...
		$this->template->setPartials(array('header', 'content_top', 'content_left', 'content_right', 'content_bottom', 'footer'));
		$this->template->render('inbox_view', $data);
	}
}
