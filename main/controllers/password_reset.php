...
class Password_reset extends Main_Controller {
	...
	public function index() {
		...
		$this->template->setBreadcrumb($this->lang->line('text_heading'), 'password_reset');
		...
		$this->template->render('password_reset', $data);
	}
	...
	public function _resetPassword() {															// method to validate password reset
		if ($this->input->post()) {
			...
			if ($this->validateForm() === TRUE) {
				...
				redirect('password_reset');												// redirect to password reset page
			}
		}
	}
...
/* Location: ./main/controllers/password_reset.php */