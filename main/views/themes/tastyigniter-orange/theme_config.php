...
$theme['theme_name'] = 'TastyIgniter Orange';
$theme['basename'] = 'tastyigniter-orange';
$theme['theme_desc'] = 'Responsive theme for front-end';
...
$theme['sections']['general'] = array(
	...
	'fields'	=> createFields(array(
		array(
			...
			'group_addon' => 'px',
			'type' 		=> 'text',
			'value'		=> set_value('logo_width', '220'),
		),
		array(
			'id'		=> 'input-logo-top',
			'name'		=> 'logo_top',
...
$theme['sections']['content_positions'] = array(
	...
	'table'		=> array(
		...
		'rows'			=> array(
			array(
				array('class' => 'action action-one', 'data' => '<a class="btn btn-times" onclick="$(this).parent().parent().remove();" data-original-title="" title=""><i class="fa fa-times-circle"></i></a>'),
				array('data' => 'Top'),
				array('data' => array(
