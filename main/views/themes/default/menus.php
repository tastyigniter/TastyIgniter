...
<div class="row margin-top">
	<ul class="nav nav-tabs menus-tabs text-sm" role="tablist">
		<li class="active"><a href="<?php echo site_url('menus'); ?>">Menu</a></li>
		<li><a href="<?php echo site_url('local'); ?>">Info</a></li>
		<li><a href="<?php echo site_url('local/reviews'); ?>">Reviews</a></li>
	</ul>
</div>

<div class="row">
	<?php echo get_partial('content_right'); ?><?php echo get_partial('content_left'); ?>
