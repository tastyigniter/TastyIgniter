...
$config['styles'] = array(
    ...
    'button_group'      => array('<div class="btn-group btn-group-{group_count}" data-toggle="buttons">', '</div>'),
    'button_label'      => array('<label class="btn btn-default {active}" data-btn="{data_btn}">', '</label>'),
