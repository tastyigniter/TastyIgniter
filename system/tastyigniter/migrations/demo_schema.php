...
/**
 * Install the demo data for tables:
 *    categories, coupons, location_tables, locations,
 *  menu_options, menu_option_values, options, option_values,
 *  menus, menus_specials, permalinks, tables, working_hours
 */

$schema['categories'] = "REPLACE INTO `" . $this->db->dbprefix . "categories` (`category_id`, `name`, `description`, `parent_id`, `priority`, `image`)
VALUES
	(15, 'Appetizer', '', 0, 0, 'data/no_photo.png'),
	(16, 'Main Course', '', 0, 0, ''),
	(17, 'Salads', '', 0, 0, ''),
	(18, 'Seafoods', '', 0, 0, ''),
	(19, 'Traditional', '', 0, 0, ''),
	...
	(23, 'Drinks', '', 0, 0, ''),
	(24, 'Specials', '', 0, 0, ''),
	(26, 'Rice Dishes', '', 16, 0, 'data/vegetable-fried-rice.jpg');
";


$schema['coupons'] = "REPLACE INTO `" . $this->db->dbprefix . "coupons` (`coupon_id`, `name`, `code`, `type`, `discount`, `min_total`, `redemptions`, `customer_redemptions`, `validity`, `fixed_date`, `fixed_from_time`, `fixed_to_time`, `period_start_date`, `period_end_date`, `recurring_every`, `recurring_from_time`, `recurring_to_time`, `description`, `status`, `date_added`) VALUES
...
$schema['location_tables'] = "REPLACE INTO `" . $this->db->dbprefix . "location_tables` (`location_id`, `table_id`)
VALUES
  (11, 7),
  (11, 16),
  (11, 17),
...
$schema['menu_option_values'] = "REPLACE INTO `" . $this->db->dbprefix . "menu_option_values` (`menu_option_value_id`, `menu_option_id`, `menu_id`, `option_id`, `option_value_id`, `new_price`, `quantity`, `subtract_stock`) VALUES
...
$schema['options'] = "REPLACE INTO `" . $this->db->dbprefix . "options` (`option_id`, `option_name`, `display_type`, `priority`) VALUES
(22, 'Cooked', 'radio', 1),
(23, 'Toppings', 'checkbox', 2),
(24, 'Dressing', 'select', 3);
";

$schema['option_values'] = "REPLACE INTO `" . $this->db->dbprefix . "option_values` (`option_value_id`, `option_id`, `value`, `price`, `priority`) VALUES
...
$schema['menus'] = "REPLACE INTO `" . $this->db->dbprefix . "menus` (`menu_id`, `menu_name`, `menu_description`, `menu_price`, `menu_photo`, `menu_category_id`, `stock_qty`, `minimum_qty`, `subtract_stock`, `menu_status`) VALUES
...
$schema['menus_specials'] = "REPLACE INTO `" . $this->db->dbprefix . "menus_specials` (`special_id`, `menu_id`, `start_date`, `end_date`, `special_price`, `special_status`) VALUES
...
$schema['permalinks'] = "REPLACE INTO `" . $this->db->dbprefix . "permalinks` (`permalink_id`, `slug`, `controller`, `query`) VALUES
...
$schema['permalinks_for_multi'] = "REPLACE INTO `" . $this->db->dbprefix . "permalinks` (`permalink_id`, `slug`, `controller`, `query`) VALUES
  (43, 'demo-location-1', 'local', 'location_id=12'),
  (44, 'demo-location-2', 'local', 'location_id=13');
";

$schema['tables'] = "REPLACE INTO `" . $this->db->dbprefix . "tables` (`table_id`, `table_name`, `min_capacity`, `max_capacity`, `table_status`) VALUES
	(1, 'EE10', 2, 10, 1),
	(2, 'NN02', 2, 4, 1),
	(6, 'SW77', 10, 40, 1),
	(7, 'EW77', 2, 8, 1),
...
$schema['working_hours_for_multi'] = "REPLACE INTO `" . $this->db->dbprefix . "working_hours` (`location_id`, `weekday`, `opening_time`, `closing_time`, `status`) VALUES
