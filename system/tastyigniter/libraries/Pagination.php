...
class CI_Pagination {
	 ...
	 * @var	string
	 */
	protected $first_link		= '<i class="fa fa-angle-left"></i>';
	 ...
	 * @var	string
	 */
	protected $prev_link		= '<i class="fa fa-angle-double-left"></i>';
	...
	protected $text = 'Displaying {start} to {end} of {total}';
