 ...
 *
 * @category       Models
 * @package        Igniter\Models\Setup_model.php
 * @link           http://docs.tastyigniter.com
 */
class Setup_model extends TI_Model
{
	protected $schema = [];
    protected $prefs_keys = ['ti_setup', 'ti_version', 'site_key', 'installed_extensions'];
	...
	public function updateSettings($setting = [])
	{
		foreach ($setting as $key => $value) {
			$setting_row = [
				'sort'       => (in_array($key, $this->prefs_keys)) ? 'prefs' : 'config',
				'item'       => $key,
	...
	public function updateInstalledExtensions()
	{
        ...
        $this->updateSettings(['installed_extensions' => $installed_extensions]);
    }
