...
class Modules
{
	...
	public static function initialize()
	{
        ...
        log_message('info', 'Modules Class Initialized');
    }
	...
	public static function load($module)
	{
		...
		if (!isset(self::$registry[$alias])) {
			...
			$path = TI_APPPATH . 'controllers/' . CI::$APP->router->directory;
	...
	public static function load_extensions()
	{
        ...
        // Boot all extensions before Router is loaded.
	...
	public static function load_extension($name, $path)
	{
		...
		if (!class_exists('BaseExtension')) {
			if (is_file($location = IGNITEPATH . 'core/BaseExtension' . '.php')) {
				include_once $location;
			}
		}
	...
	public static function initialize_extensions()
	{
		...
		foreach (self::$extensions as $name => $extension) {
			self::initialize_extension($extension);
		}
	 ...
	 *
	 * @param Igniter\Core\BaseExtension $extension
	 *
	 * @return void
	 */
	public static function initialize_extension($extension = null)
	{
		if (!$extension) {
			return;
		}
