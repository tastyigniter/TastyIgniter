<form role="form" class="form-horizontal" accept-charset="utf-8" method="POST" action="<?php echo current_url(); ?>" >
	<div class="form-group">
		<label for="input-site-name" class="col-sm-4 control-label"><?php echo lang('label_site_name'); ?></label>
		<div class="col-sm-8">
	...
	<div class="form-group">
		<label for="input-site-email" class="col-sm-4 control-label"><?php echo lang('label_site_email'); ?></label>
		<div class="col-sm-8">
	...
	<h4><?php echo lang('text_admin_details'); ?></h4>
	<div class="form-group">
		<label for="input-staff-name" class="col-sm-4 control-label"><?php echo lang('label_staff_name'); ?></label>
		<div class="col-sm-8">
	...
	<div class="form-group">
		<label for="input-username" class="col-sm-4 control-label"><?php echo lang('label_username'); ?></label>
		<div class="col-sm-8">
	...
	<div class="form-group">
		<label for="input-password" class="col-sm-4 control-label"><?php echo lang('label_password'); ?></label>
		<div class="col-sm-8">
	...
	<div class="form-group">
		<label for="input-confirm-password" class="col-sm-4 control-label"><?php echo lang('label_confirm_password'); ?></label>
		<div class="col-sm-8">
	...
	<div class="form-group">
		<label for="input-demo-data" class="col-sm-4 control-label"><?php echo lang('label_demo_data'); ?></label>
		<div class="col-sm-8">
			<div class="checkbox">
